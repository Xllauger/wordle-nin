document.addEventListener("DOMContentLoaded", () => {
  ...
  function loadLocalStorage() {
    ...
    // Controla si s'ha arribat al final de la llista de paraules - reinicia
    ...
    //window.alert(currentWordIndex + " " + currentWord + " " + guessedWordCount + " " + availableSpace + " " + guessedWords);
